...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      {/* Top Mobile Navbar */}
      <nav className="bg-blue-900 text-white flex items-center justify-between px-4 py-3 h-14 shadow-md md:hidden fixed top-0 left-0 right-0 z-50">
      ...
      {/* Mobile Drawer */}
      <div
        className={`fixed top-14 left-0 h-fit w-full bg-blue-950 text-white transform ${
